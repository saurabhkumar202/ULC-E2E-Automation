...
describe('Browse Product from product drop down', function () {
    beforeAll(function () {
    ...
    it('Should display Browse Content button on browse results Page', function () {
        expect(browseResultsPage.browseContentButton.isDisplayed()
        ).toBe(true);
    });

    it('Should display Content Language button on browse results Page', function () {
        expect(browseResultsPage.contentLanguage.isDisplayed()
        ).toBe(true);
    });
    ...
    it('Should display message as "No Content Available"', function () {
        ...
        browseResultsPage.contentLanguageKorean.click();
        browser.waitForAngular();
        expect(browseResultsPage.noContentSectionBrowse).toEqual(message);
    });
