...
exports.config = {
    ...
    params: {
        ...
        ulcOptions: {
            ...
            dummyClient: 'http://10.76.2.55/dummyclient/lc_host_application.html',
            thingworxURL: 'http://Administrator:Thingworx@12345!@10.76.2.12:8080/Thingworx/Composer/index.html',
        ...
        apiType: {
           ...
           // LEARNING_CONNECTOR_BROWSE:"^http://10.76.2.81:8081/lexredirect.*"
            ...
            ADS_TUTORIAL:"^https.*ptcuClasses.*family.*product.*language.*page.*"
    ...
    specs: ['com/ptcu/ulc/tests/API/*.spec.js','com/ptcu/ulc/tests/smoke/*.spec.js','com/ptcu/ulc/tests/LearningExchangeRedirection/*.spec.js','com/ptcu/ulc/tests/sanity/windchill.launch.spec.js','com/ptcu/ulc/tests/sanity/windchill.recommendations.api.spec.js','com/ptcu/ulc/tests/sanity/thingworx.launch.spec.js','com/ptcu/ulc/tests/sanity/thingworx.recommendations.api.spec.js'],
